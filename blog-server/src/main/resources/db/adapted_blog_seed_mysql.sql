...
SELECT
  ...
  '/files/covers/admin-features.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 1, 1, 980, 42,
...
SELECT
  ...
  '/files/covers/taxonomy-design.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 0, 1, 760, 33,
...
SELECT
  ...
  '/files/covers/database-design.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 1, 1, 1540, 73,
...
SELECT
  ...
  '/files/covers/recommendation.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 1, 1, 1880, 91,
...
SELECT
  ...
  '/files/covers/vue3-homepage.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 0, 1, 860, 37,
...
SELECT
  ...
  '/files/covers/markdown-editor.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 0, 1, 940, 41,
...
SELECT
  ...
  '/files/covers/retrospective.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  1, 1, 1, 2100, 105,
...
SELECT
  ...
  '/files/covers/writing-rhythm.png',
  u.id,
  c.id,
  'PUBLISHED', 'PUBLIC',
  0, 0, 1, 730, 27,
